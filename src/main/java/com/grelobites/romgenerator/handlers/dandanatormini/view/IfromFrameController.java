...
public class IfromFrameController {
    private static final Logger LOGGER = LoggerFactory.getLogger(IfromFrameController.class);

    private static final String BLUE_BAR_STYLE = "blue-bar";
    private static final String RED_BAR_STYLE = "red-bar";

    protected IfromFrameController ifromFrameController;
