...
public class DandanatorMiniV8Importer implements DandanatorMiniImporter {
    private static final Logger LOGGER = LoggerFactory.getLogger(DandanatorMiniV8Importer.class);
