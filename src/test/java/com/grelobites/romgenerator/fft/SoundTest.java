...
public class SoundTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(SoundTest.class);

    @Test
    public void testSineWave() throws Exception {
        ToneInputStream is = new ToneInputStream(44100.0f, AudioSystem.NOT_SPECIFIED, 1.0, 1000.0);
