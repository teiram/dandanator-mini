...
public class TapeLoader128Test implements Z80operations {
    ...
    public void outPort(int port, int value) {
        LOGGER.debug("outPort 0x" +  Integer.toHexString(port));
    ...
    private void loadTapeLoader() {
        try (InputStream loaderStream = TapeLoader128Test.class
                .getResourceAsStream("/loader/loader.+2.z80")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Game game = loader.loadTape(new FileInputStream("/Users/mteira/Desktop/Dandanator/tap/128/dizzy4.tap"));

        GameUtil.pushPC((RamGame) game);
        try (FileOutputStream fos = new FileOutputStream("/Users/mteira/Desktop/Dandanator/tap/128/dizzy4.z80")) {
